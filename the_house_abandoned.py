...
def scary_game_start():
    ...
    print("You pull up to the driveway and you are reminded of what this house used to be. You remember the white railing that went along the front porch. The blue siding of the house with the complementry red door. The two chairs that Ma and Pa used to read every Saturday morning in. The grass the could never grow no matter what Ma's friends put on it. All tied together with a fence that used to keep Charlie, your old dog, inside.")
    print("look around | get out of car ")
    user_car = input("")
    
    def in_car(have_key, have_note):
        ...
        if user_look_car == "open glovebox":
            ...
            if user_take_key == "yes":
                print("You take the keys hopeing they're the keys for the house, you don't remember for some reason")
                have_key = True
                ...
                print("you dont take the keys for some reason hoping they arent important and contiune to do what you were doing.")
                have_key = False
                print("Would you like to take the note?")
                take_note = input("")
                if take_note == "yes":
    ...
    def house_has_power(house_power, have_key):
        if house_power == True :
            print("The house makes a loud 'wirling' sound and boots up like a Windows Home Vista")
